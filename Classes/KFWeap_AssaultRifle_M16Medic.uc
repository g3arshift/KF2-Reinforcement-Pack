...
//	-Brooks Butler
//=============================================================================
class KFWeap_AssaultRifle_M16Medic extends KFWeap_RifleBase;
...
defaultproperties
{
	...
	PackageKey="M16_Reddot"
	FirstPersonMeshName="'WEP_1P_M16_REDDOT_MESH.Wep_1stP_M16_M203_Rig'"
	FirstPersonAnimSetNames(0)="'wep_1p_m16_m203_anim.Wep_1stP_M16_M203_Anim'"
	PickupMeshName="'WEP_3P_M16_REDDOT_MESH.Wep_M4_M203_Pickup'"
	AttachmentArchetypeName="'Wep_M16_REDDOT_ARCH.Wep_M16_REDDOT_3P_NEW'"
	MuzzleFlashTemplateName="'wep_m16_m203_arch.Wep_M16_M203_MuzzleFlash'"

   	// Zooming/Position
	PlayerViewOffset=(X=18.0,Y=9.f,Z=-2.f)
	
	IronSightPosition=(X=0,Y=-0.08,Z=-0.2)
	...
	InventorySize=6
	GroupPriority=70
	WeaponSelectTexture=Texture2D'WEP_UI_M16_REDDOT_TEX.UI_WeaponSelect_M16M203'
	...
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_M16Medic'
	FireInterval(DEFAULT_FIREMODE)=+0.086 // 700 RPM
	Spread(DEFAULT_FIREMODE)=0.0085
	InstantHitDamage(DEFAULT_FIREMODE)=38.0 //24
	...
	WeaponProjectiles(ALTFIRE_FIREMODE)=class'KFProj_Nade_Medic40mm'
	...
	WeaponUpgrades[3]=(Stats=((Stat=EWUS_Damage0, Scale=1.48f), (Stat=EWUS_Damage1, Scale=1.48f), (Stat=EWUS_Weight, Add=0)))
